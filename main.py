...
class UserSentiment:
    ...
    def generate(self, user_review):
        ...
        miss any insight from the text also avoid giving irrelevant sentiments in output. Your answer should be strictly according to the given structure only.
        ...
        answer: [value for money positive]
        ...
        answer : [ease of booking positive, length of fitting positive, advisor/agent service positive] 
        
        For example 4:
        text: Simple to order. Easy to book your appointment. Tyres turned up on time. Fitters did a great job.
        answer:[delivery punctuality positive, ease of booking positive]
        
        For example 5:
        text:Not a 10 as I found the garage a bit difficult to find
        answer: [location negative]
        ...
        answer:[booking confusion negative, garage service positive]
